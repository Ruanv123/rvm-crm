    ...
    <aside className="h-screen w-fit">
      <nav className="h-full flex flex-col border-r shadow-sm">
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          >
            {expanded ? <ArrowLeft01Icon /> : <ArrowRight01Icon />}
          </button>
        </div>
      ...
      className={`
        ...
        ${
          active
            ...
            : "hover:bg-indigo-50 dark:text-gray-400 hover:text-gray-600"
        }
    `}
    >
      {icon}
      ...
      {!expanded && (
        <div
          ...
          bg-indigo-100 text-indigo-800 dark:text-indigo-200 text-sm
